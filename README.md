...
- Extended [AddressBookService.java](/c:/Users/ASUS/OneDrive/Desktop/AddressBookApp/src/main/java/com/addressbookapp/service/AddressBookService.java) with:
  - `getPersonsGroupedByCity()`
  - `getPersonsGroupedByState()`
- Implemented grouping using Java Stream API and `Collectors.groupingBy(...)`
- Grouped contacts across all address books by:
  - `Contact::getCity`
  - `Contact::getState`
...
- Confirmed that grouped collections contain the expected number of matching persons

#### Outcome

UC9 successfully adds grouped viewing of persons by city and state, improving how contacts can be organized and interpreted across address books.
