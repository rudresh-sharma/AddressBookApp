...
The application starts with the core `Contact` model and expands through small, well-defined features such as adding contacts, editing details, deleting records, searching entries, sorting data, and eventually supporting persistence.
...
- Updated the following fields when a match is found:
  - Address
  - City
  - State
  - Zip
